...
while True:
    ...
    for i in a:
        ...
        with db.cursor() as cursor:
            try:
                sql = "INSERT INTO video_copy1(`source`,`ref_id`,`video_path`,`image_path`,`title`,`size`,`status`,`video_id_test`,`video_id_prod`) values('美拍美妆',{},'{}','{}','{}',0,0,0,0)".format(
                    id, video_path, image_path, caption)
                cursor.execute(sql)
